...
card_g = length(alphaList);
phenotypeFactor = struct('var', [phenotypeVar genotypeVar], 'card', [2 card_g], 'val', []);
...
for g = 1:card_g
  phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1 g], alphaList(g));
  phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2 g], 1 - alphaList(g));
end
