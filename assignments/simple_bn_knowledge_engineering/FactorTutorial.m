...
% disp('Test case')
% disp(FACTORS.PRODUCT.var)
% disp(FACTORS.PRODUCT.card)
% disp(FACTORS.PRODUCT.val)
%
% disp('___')
% x = FactorProduct(FACTORS.INPUT(1), FACTORS.INPUT(2));
% disp('___')
%
% disp('Output')
% disp(x.var)
...
% disp('Test case')
% disp(FACTORS.MARGINALIZATION.var)
% disp(FACTORS.MARGINALIZATION.card)
% disp(FACTORS.MARGINALIZATION.val)
%
% disp('___')
% x = FactorMarginalization(FACTORS.INPUT(2), [2]);
% disp('___')
%
% disp('Output')
% disp(x.var)
...
% disp('Test case')
% disp(FACTORS.EVIDENCE(1).val)
% disp(FACTORS.EVIDENCE(2).val)
% disp(FACTORS.EVIDENCE(3).val)
%
% disp('___')
% x = ObserveEvidence(FACTORS.INPUT, [2 1; 3 2]);
% disp('___')
%
% disp('Output')
% disp(x(1).val)
...
% disp('Test case')
% disp(FACTORS.JOINT.var)
% disp(FACTORS.JOINT.card)
% disp(FACTORS.JOINT.val)
%
% disp('___')
% x = ComputeJointDistribution(FACTORS.INPUT);
% disp('___')
%
% disp('Output')
% disp(x.var)
...
% disp('Test case')
% disp(FACTORS.MARGINAL.var)
% disp(FACTORS.MARGINAL.card)
% disp(FACTORS.MARGINAL.val)
%
% disp('___')
% x = ComputeMarginal([2, 3], FACTORS.INPUT, [1, 2]);
% disp('___')
%
% disp('Output')
% disp(x.var)
